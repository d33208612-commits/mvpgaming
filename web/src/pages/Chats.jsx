  ...
  return (
    <div className="page">
      ...
      {chats === null ? (
        ...
        <p className="empty">Пока нет переписок. Откликнитесь на вакансию или напишите работодателю.</p>
      ) : (
              ...
              >
                ...
                <div className="chat-row-body">
                  <div className="chat-row-top">
                    <span className="chat-name">{c.peer?.company || c.peer?.name || 'Пользователь'}</span>
                    <span className="muted small">{timeAgo(c.last_at)}</span>
                  </div>
                  {c.vacancy_title && <span className="chat-vac">по вакансии «{c.vacancy_title}»</span>}
