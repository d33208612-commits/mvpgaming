          ...
          {vacancies.map((v) => (
            <div key={v.id} className="card" style={{ padding: 16 }}>
              ...
              <div className="vac-tags">
                ...
                {v.status === 'closed' && <span className="tag">{t('closedBadge')}</span>}
              ...
              <div className="info-row" style={{ borderTop: '1px solid var(--border)', marginTop: 12, paddingTop: 12 }}>
              ...
              {v.contact_type === 'phone' && v.contact_phone && (
                <div className="info-row" style={{ paddingTop: 8, borderBottom: 'none' }}>
